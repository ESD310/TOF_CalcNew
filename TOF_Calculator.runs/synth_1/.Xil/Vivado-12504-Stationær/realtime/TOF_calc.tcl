...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/temp/TOF_Calculator/TOF_Calculator.runs/synth_1/.Xil/Vivado-12504-Stationær/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_vhdl -lib xil_defaultlib C:/temp/TOF_Calculator/TOF_Calculator.srcs/sources_1/new/TOF_calc.vhd
      rt::filesetChecksum
    }
...
# MODE: 
    rt::set_parameter webTalkPath {C:/temp/TOF_Calculator/TOF_Calculator.cache/wt}
    rt::set_parameter synthDebugLog false
    rt::set_parameter printModuleName false
    rt::set_parameter enableSplitFlowPath "C:/temp/TOF_Calculator/TOF_Calculator.runs/synth_1/.Xil/Vivado-12504-Stationær/"
