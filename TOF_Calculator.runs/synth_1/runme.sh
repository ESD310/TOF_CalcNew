...
HD_PWD='C:/temp/TOF_Calculator/TOF_Calculator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOF_calc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOF_calc.tcl
